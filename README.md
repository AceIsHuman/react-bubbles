...
A token is used to verify a user should have access to make a request from an API. 

- [x] What steps can you take in your web apps to keep your data secure?

We can wrap pages in PrivateRoutes to prevent a user from access them without a token.

- [x] Describe how web servers work.

A web server handles data/code passed to a client upon request.
